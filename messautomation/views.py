...
def email(to,subject,body):
    ...
    # print body
    send_mail(subject,body,'adarshs@iitk.ac.in',[to],
                          fail_silently=False)
...
def item_extra(request,rollnumber):
	...
	#img_url = "http://oa.cc.iitk.ac.in:8181/Oa/Jsp/Photo/"+rollnumber+"_0.jpg"
	img_url = ""
	bdmr = 0
...
def forgot_password(request):
	...
	if rollnumber != False:
		...
		user.save()
		to = email_user
		subject = "Mess Automation System:Your New Password"
